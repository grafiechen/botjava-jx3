 ...
 */
public class WatchStatisticalAction extends Jx3BaseAction {
    public WatchStatisticalAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil, GroupInfoMapper groupInfoMapper) {
