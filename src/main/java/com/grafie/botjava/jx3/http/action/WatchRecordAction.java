 ...
 * 烟花记录
 * @author grafie.chen
 * @since 2025/1/22  17:26
 */
public class WatchRecordAction extends Jx3BaseAction {
    public WatchRecordAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil, GroupConfigurationService groupConfigurationService) {
