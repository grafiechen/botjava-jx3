...
@Jx3Action
public class CardPresetAction extends OfficialExtensionActionSupport {
    public CardPresetAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil,
    ...
    protected BotResponse dealAfterJx3ApiRequest(BaseResult baseResult) {
        return buildReadableText("名片预设", baseResult);
    }
}