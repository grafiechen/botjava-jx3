 ...
 */
public class WatchCollectAction extends Jx3BaseAction {
    public WatchCollectAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil, GroupInfoMapper groupInfoMapper) {
