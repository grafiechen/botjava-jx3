...
@Jx3Action
public class RankConstableAction extends OfficialExtensionActionSupport {
    public RankConstableAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil,
    ...
    protected BotResponse dealAfterJx3ApiRequest(BaseResult baseResult) {
        return rankText("捕快荣誉", baseResult);
    }
}