...
@Jx3Action
public class RankOutlawAction extends OfficialExtensionActionSupport {
    public RankOutlawAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil,
    ...
    protected BotResponse dealAfterJx3ApiRequest(BaseResult baseResult) {
        return rankText("江湖浪客", baseResult);
    }
}