 ...
 */
@Jx3Action
public class SaveDetailedAction extends Jx3BaseAction {
    public SaveDetailedAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil, GroupInfoMapper groupInfoMapper) {
