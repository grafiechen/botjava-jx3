 ...
 */
@Jx3Action
public class MusicKugouAction extends Jx3BaseAction {
    public MusicKugouAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil, GroupInfoMapper groupInfoMapper) {
