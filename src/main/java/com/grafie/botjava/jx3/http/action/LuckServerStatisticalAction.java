 ...
 */
@Jx3Action
public class LuckServerStatisticalAction extends Jx3BaseAction {
    public LuckServerStatisticalAction(ApiProperties apiProperties, Jx3RequestUtil jx3RequestUtil, GroupInfoMapper groupInfoMapper) {
